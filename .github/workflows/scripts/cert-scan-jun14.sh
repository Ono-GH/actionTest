...
jira_check() {
    ...
    # Query Jira and extract data in response - pipe to .json file to parse
    curl -D- -s -u svc_jira-admin:QAZwsx@123 -X GET -H "Content-Type: application/json" \
    ...
    BUG_KEY=$(jq .issues[0].key tempBug.json)
